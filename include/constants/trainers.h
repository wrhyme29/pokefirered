...
// All trainer parties specify the IV, level, and species for each Pokémon in the party. 
// Some trainer parties also specify held items, custom moves, or abilities for each Pokémon.
#define F_TRAINER_PARTY_CUSTOM_MOVESET      (1 << 0)
#define F_TRAINER_PARTY_HELD_ITEM           (1 << 1)
#define F_TRAINER_PARTY_CUSTOM_ABILITIES    (1 << 2)
