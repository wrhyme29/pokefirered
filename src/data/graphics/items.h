...
const u32 gItemIcon_PortaPc[] = INCBIN_U32("graphics/items/icons/porta_pc.4bpp.lz");
const u32 gItemIconPalette_PortaPc[] = INCBIN_U32("graphics/items/icon_palettes/porta_pc.gbapal.lz");
